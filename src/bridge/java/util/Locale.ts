...
export declare class LocaleClass extends JavaClass {
  ...
  public static filter(
    var0: java_util_List | null,
    var1: java_util_Collection | null,
    var2: java_util_Locale$FilteringMode | null,
  ): Promise<java_util_List | null>;
  // ================== Method filter ==================
  /**
   * @param var0 original type: 'java.util.List'
   * @param var1 original type: 'java.util.Collection'
