...
/**
 * This class just defines types, you should import Locale$FilteringMode instead of this.
...
export declare class Locale$FilteringModeClass extends JavaClass {
   ...
   */
  public static readonly AUTOSELECT_FILTERING: Locale$FilteringModeClass | null;
  // ================== Field EXTENDED_FILTERING ==================
  /**
   * Original type: 'java.util.Locale$FilteringMode'
   */
  public static readonly EXTENDED_FILTERING: Locale$FilteringModeClass | null;
  // ================== Field IGNORE_EXTENDED_RANGES ==================
  /**
   * Original type: 'java.util.Locale$FilteringMode'
   */
  public static readonly IGNORE_EXTENDED_RANGES: Locale$FilteringModeClass | null;
  // ================== Field MAP_EXTENDED_RANGES ==================
  /**
   * Original type: 'java.util.Locale$FilteringMode'
   */
  public static readonly MAP_EXTENDED_RANGES: Locale$FilteringModeClass | null;
  // ================== Field REJECT_EXTENDED_RANGES ==================
  /**
   * Original type: 'java.util.Locale$FilteringMode'
   */
  public static readonly REJECT_EXTENDED_RANGES: Locale$FilteringModeClass | null;
  // ================== Method values ==================
  /**
   * @return original return type: 'java.util.Locale$FilteringMode[]'
   */
  public static values(): Promise<(Locale$FilteringMode | null)[] | null>;
  // ================== Method values ==================
  /**
   * @return original return type: 'java.util.Locale$FilteringMode[]'
   */
  public static valuesSync(): (Locale$FilteringMode | null)[] | null;
  // ================== Method valueOf ==================
  /**
   * @param var0 original type: 'java.lang.String'
   * @return original return type: 'java.util.Locale$FilteringMode'
   */
  public static valueOf(var0: string | null): Promise<Locale$FilteringMode | null>;
  // ================== Method valueOf ==================
  /**
   * @param var0 original type: 'java.lang.String'
   * @return original return type: 'java.util.Locale$FilteringMode'
   */
  public static valueOfSync(var0: string | null): Locale$FilteringMode | null;
  /**
 ...
 * The class Locale$FilteringModeClass only defines types, this is the class you should actually import.
 * Please note that this statement imports the underlying java class at runtime, which may take a while.
 * This was generated by java-bridge.
 * You should probably not edit this.
 */
export class Locale$FilteringMode extends importClass<typeof Locale$FilteringModeClass>(
