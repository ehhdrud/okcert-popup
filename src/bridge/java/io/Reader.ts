...
/**
 * This class just defines types, you should import Reader instead of this.
...
export declare class ReaderClass extends JavaClass {
   ...
   */
  public read(var0: (string | null)[] | null): Promise<number>;
  // ================== Method read ==================
  /**
   * @param var0 original type: 'char[]'
   * @return original return type: 'int'
   */
  public readSync(var0: (string | null)[] | null): number;
  /**
   * @param var0 original type: 'char[]'
   ...
   * @return original return type: 'int'
   */
  public read(var0: java_nio_CharBuffer | null): Promise<number>;
  /**
   * @param var0 original type: 'java.nio.CharBuffer'
   * @return original return type: 'int'
   */
  public readSync(var0: java_nio_CharBuffer | null): number;
  // ================== Method close ==================
  /**
 ...
 * The class ReaderClass only defines types, this is the class you should actually import.
 * Please note that this statement imports the underlying java class at runtime, which may take a while.
 * This was generated by java-bridge.
 * You should probably not edit this.
 */
export class Reader extends importClass<typeof ReaderClass>('java.io.Reader') {
  /**
