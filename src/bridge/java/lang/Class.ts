...
export declare class ClassClass extends JavaClass {
  ...
  public static forName(
    ...
    var2: java_lang_ClassLoader | null,
  ): Promise<Class | null>;
  /**
   * @param var0 original type: 'java.lang.String'
   * @param var1 original type: 'boolean'
  ...
  public getDeclaredMethod(
    var0: string | null,
    var1: (ClassClass | null)[] | null,
  ): Promise<java_lang_reflect_Method | null>;
  // ================== Method getDeclaredMethod ==================
  /**
   * @param var0 original type: 'java.lang.String'
   * @param var1 original type: 'java.lang.Class[]'
