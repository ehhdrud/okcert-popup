...
export declare class AbstractStringBuilderClass extends JavaClass {
  ...
  ): Promise<AbstractStringBuilder | null>;
  // ================== Method append ==================
  /**
   * @param var0 original type: 'java.lang.CharSequence'
   * @param var1 original type: 'int'
  ...
  public append(
    ...
    var1: java_lang_Integer | number,
    var2: java_lang_Integer | number,
  ): Promise<java_lang_Appendable | null>;
  /**
   * @param var0 original type: 'java.lang.CharSequence'
   * @param var1 original type: 'int'
   * @param var2 original type: 'int'
  ...
  public subSequence(
    var0: java_lang_Integer | number,
    var1: java_lang_Integer | number,
  ): Promise<java_lang_CharSequence | null>;
  // ================== Method subSequence ==================
  /**
   * @param var0 original type: 'int'
   * @param var1 original type: 'int'
   * @return original return type: 'java.lang.CharSequence'
   */
  public subSequenceSync(
    var0: java_lang_Integer | number,
    var1: java_lang_Integer | number,
  ): java_lang_CharSequence | null;
  // ================== Method replace ==================
  /**
   * @param var0 original type: 'int'
   * @param var1 original type: 'int'
  ...
  public insert(
    var0: java_lang_Integer | number,
    var1: java_lang_CharSequence | null,
    var2: java_lang_Integer | number,
    var3: java_lang_Integer | number,
  ): Promise<AbstractStringBuilder | null>;
  /**
 ...
 * You should probably not edit this.
 */
export class AbstractStringBuilder extends importClass<typeof AbstractStringBuilderClass>(
