...
export declare class AsynchronousFileChannelClass extends JavaClass {
  ...
  public tryLock(
    ...
    var2: java_lang_Boolean | boolean,
  ): Promise<java_nio_channels_FileLock | null>;
  // ================== Method tryLock ==================
  /**
   * @param var0 original type: 'long'
   * @param var1 original type: 'long'
  ...
  public tryLockSync(
    ...
    var1: java_lang_Long | bigint | number,
    var2: java_lang_Boolean | boolean,
  ): java_nio_channels_FileLock | null;
  /**
   * @return original return type: 'java.nio.channels.FileLock'
   */
  ...
  public lock(
    ...
    var1: java_lang_Long | bigint | number,
    var2: java_lang_Boolean | boolean,
  ): Promise<java_util_concurrent_Future | null>;
  /**
   * @param var0 original type: 'long'
   * @param var1 original type: 'long'
   * @param var2 original type: 'boolean'
  ...
  public lockSync(
    ...
    var1: java_lang_Long | bigint | number,
    var2: java_lang_Boolean | boolean,
  ): java_util_concurrent_Future | null;
  /**
   * @param var0 original type: 'long'
   * @param var1 original type: 'long'
   * @param var2 original type: 'boolean'
  ...
  public lock(
    ...
    var1: java_lang_Long | bigint | number,
    var2: java_lang_Boolean | boolean,
    var3: BasicOrJavaType | null,
    var4: java_nio_channels_CompletionHandler | null,
  ): Promise<void>;
  /**
   * @param var0 original type: 'long'
   * @param var1 original type: 'long'
   ...
   */
  public write(
    var0: java_nio_ByteBuffer | null,
    var1: java_lang_Long | bigint | number,
    var2: BasicOrJavaType | null,
    var3: java_nio_channels_CompletionHandler | null,
  ): Promise<void>;
  // ================== Method write ==================
  /**
   * @param var0 original type: 'java.nio.ByteBuffer'
  ...
  ): Promise<AsynchronousFileChannel | null>;
  // ================== Method open ==================
  /**
   * @param var0 original type: 'java.nio.file.Path'
   * @param var1 original type: 'java.nio.file.OpenOption[]'
 ...
 * You should probably not edit this.
 */
export class AsynchronousFileChannel extends importClass<typeof AsynchronousFileChannelClass>(
