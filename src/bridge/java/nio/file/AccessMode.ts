...
/**
 * This class just defines types, you should import AccessMode instead of this.
...
export declare class AccessModeClass extends JavaClass {
   ...
   */
  public static readonly READ: AccessModeClass | null;
  // ================== Field WRITE ==================
  /**
   * Original type: 'java.nio.file.AccessMode'
   */
  public static readonly WRITE: AccessModeClass | null;
  // ================== Field EXECUTE ==================
  /**
   * Original type: 'java.nio.file.AccessMode'
   */
  public static readonly EXECUTE: AccessModeClass | null;
  // ================== Method values ==================
  /**
   * @return original return type: 'java.nio.file.AccessMode[]'
   */
  public static values(): Promise<(AccessMode | null)[] | null>;
  // ================== Method values ==================
  /**
   * @return original return type: 'java.nio.file.AccessMode[]'
   */
  public static valuesSync(): (AccessMode | null)[] | null;
  // ================== Method valueOf ==================
  /**
   * @param var0 original type: 'java.lang.String'
   * @return original return type: 'java.nio.file.AccessMode'
   */
  public static valueOf(var0: string | null): Promise<AccessMode | null>;
  // ================== Method valueOf ==================
  /**
   * @param var0 original type: 'java.lang.String'
   * @return original return type: 'java.nio.file.AccessMode'
   */
  public static valueOfSync(var0: string | null): AccessMode | null;
  /**
 ...
 * The class AccessModeClass only defines types, this is the class you should actually import.
 * Please note that this statement imports the underlying java class at runtime, which may take a while.
 * This was generated by java-bridge.
 * You should probably not edit this.
 */
export class AccessMode extends importClass<typeof AccessModeClass>('java.nio.file.AccessMode') {}
