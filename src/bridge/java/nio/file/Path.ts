...
export declare class PathClass extends JavaClass {
   ...
   */
  public register(
    var0: java_nio_file_WatchService | null,
    var1: (java_nio_file_WatchEvent$Kind | null)[] | null,
    var2: (java_nio_file_WatchEvent$Modifier | null)[] | null,
  ): Promise<java_nio_file_WatchKey | null>;
  // ================== Method register ==================
  /**
   * @param var0 original type: 'java.nio.file.WatchService'
   * @param var1 original type: 'java.nio.file.WatchEvent$Kind[]'
