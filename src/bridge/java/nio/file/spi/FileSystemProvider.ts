...
export declare class FileSystemProviderClass extends JavaClass {
   ...
   */
  public setAttribute(
    var0: java_nio_file_Path | null,
    var1: string | null,
    var2: BasicOrJavaType | null,
    var3: (java_nio_file_LinkOption | null)[] | null,
  ): Promise<void>;
  // ================== Method setAttribute ==================
  /**
   * @param var0 original type: 'java.nio.file.Path'
  ...
  public newInputStream(
    var0: java_nio_file_Path | null,
    var1: (java_nio_file_OpenOption | null)[] | null,
  ): Promise<java_io_InputStream | null>;
  // ================== Method newInputStream ==================
  /**
   * @param var0 original type: 'java.nio.file.Path'
   * @param var1 original type: 'java.nio.file.OpenOption[]'
   * @return original return type: 'java.io.InputStream'
   */
  public newInputStreamSync(
    var0: java_nio_file_Path | null,
    var1: (java_nio_file_OpenOption | null)[] | null,
  ): java_io_InputStream | null;
  ...
  public newOutputStream(
    var0: java_nio_file_Path | null,
    var1: (java_nio_file_OpenOption | null)[] | null,
  ): Promise<java_io_OutputStream | null>;
  // ================== Method newOutputStream ==================
  /**
   * @param var0 original type: 'java.nio.file.Path'
   * @param var1 original type: 'java.nio.file.OpenOption[]'
   * @return original return type: 'java.io.OutputStream'
   */
  public newOutputStreamSync(
    var0: java_nio_file_Path | null,
    var1: (java_nio_file_OpenOption | null)[] | null,
  ): java_io_OutputStream | null;
  ...
  public newFileSystem(
    var0: java_nio_file_Path | null,
    var1: java_util_Map | null,
  ): Promise<java_nio_file_FileSystem | null>;
  // ================== Method newFileSystem ==================
  /**
   * @param var0 original type: 'java.nio.file.Path'
   * @param var1 original type: 'java.util.Map'
   * @return original return type: 'java.nio.file.FileSystem'
   */
  public newFileSystemSync(
    var0: java_nio_file_Path | null,
    var1: java_util_Map | null,
  ): java_nio_file_FileSystem | null;
  /**
   ...
   */
  public getFileAttributeView(
    var0: java_nio_file_Path | null,
    var1: java_lang_Class | null,
    var2: (java_nio_file_LinkOption | null)[] | null,
  ): Promise<java_nio_file_attribute_FileAttributeView | null>;
  // ================== Method getFileAttributeView ==================
  /**
   * @param var0 original type: 'java.nio.file.Path'
   * @param var1 original type: 'java.lang.Class'
   ...
   * @return original return type: 'java.nio.file.attribute.FileAttributeView'
   */
  public getFileAttributeViewSync(
    var0: java_nio_file_Path | null,
    var1: java_lang_Class | null,
    var2: (java_nio_file_LinkOption | null)[] | null,
  ): java_nio_file_attribute_FileAttributeView | null;
  ...
  public readAttributes(
    ...
    var1: java_lang_Class | null,
    var2: (java_nio_file_LinkOption | null)[] | null,
  ): Promise<java_nio_file_attribute_BasicFileAttributes | null>;
  // ================== Method readAttributes ==================
  /**
   * @param var0 original type: 'java.nio.file.Path'
   * @param var1 original type: 'java.lang.Class'
   ...
   * @return original return type: 'java.nio.file.attribute.BasicFileAttributes'
   */
  public readAttributesSync(
    var0: java_nio_file_Path | null,
    var1: java_lang_Class | null,
    var2: (java_nio_file_LinkOption | null)[] | null,
  ): java_nio_file_attribute_BasicFileAttributes | null;
  /**
   * @param var0 original type: 'java.nio.file.Path'
   * @param var1 original type: 'java.lang.String'
   * @param var2 original type: 'java.nio.file.LinkOption[]'
  ...
  public newFileChannel(
    ...
    var2: (java_nio_file_attribute_FileAttribute | null)[] | null,
  ): Promise<java_nio_channels_FileChannel | null>;
  // ================== Method newFileChannel ==================
  /**
   * @param var0 original type: 'java.nio.file.Path'
   * @param var1 original type: 'java.util.Set'
   ...
   * @return original return type: 'java.nio.channels.FileChannel'
   */
  public newFileChannelSync(
    var0: java_nio_file_Path | null,
    var1: java_util_Set | null,
    var2: (java_nio_file_attribute_FileAttribute | null)[] | null,
  ): java_nio_channels_FileChannel | null;
  ...
  public newAsynchronousFileChannel(
    var0: java_nio_file_Path | null,
    var1: java_util_Set | null,
    var2: java_util_concurrent_ExecutorService | null,
    var3: (java_nio_file_attribute_FileAttribute | null)[] | null,
  ): Promise<java_nio_channels_AsynchronousFileChannel | null>;
  // ================== Method newAsynchronousFileChannel ==================
  /**
   * @param var0 original type: 'java.nio.file.Path'
   * @param var1 original type: 'java.util.Set'
   ...
   * @return original return type: 'java.nio.channels.AsynchronousFileChannel'
   */
  public newAsynchronousFileChannelSync(
    var0: java_nio_file_Path | null,
    var1: java_util_Set | null,
    var2: java_util_concurrent_ExecutorService | null,
    var3: (java_nio_file_attribute_FileAttribute | null)[] | null,
  ): java_nio_channels_AsynchronousFileChannel | null;
   ...
   */
  public newByteChannel(
    var0: java_nio_file_Path | null,
    var1: java_util_Set | null,
    var2: (java_nio_file_attribute_FileAttribute | null)[] | null,
  ): Promise<java_nio_channels_SeekableByteChannel | null>;
  // ================== Method newByteChannel ==================
  /**
   * @param var0 original type: 'java.nio.file.Path'
   * @param var1 original type: 'java.util.Set'
   ...
   * @return original return type: 'java.nio.channels.SeekableByteChannel'
   */
  public newByteChannelSync(
    var0: java_nio_file_Path | null,
    var1: java_util_Set | null,
    var2: (java_nio_file_attribute_FileAttribute | null)[] | null,
  ): java_nio_channels_SeekableByteChannel | null;
  // ================== Method move ==================
  /**
   * @param var0 original type: 'java.nio.file.Path'
  ...
  public move(
    var0: java_nio_file_Path | null,
    var1: java_nio_file_Path | null,
    var2: (java_nio_file_CopyOption | null)[] | null,
  ): Promise<void>;
  // ================== Method move ==================
  /**
   * @param var0 original type: 'java.nio.file.Path'
   ...
   */
  public newDirectoryStream(
    var0: java_nio_file_Path | null,
    var1: java_nio_file_DirectoryStream$Filter | null,
  ): Promise<java_nio_file_DirectoryStream | null>;
  // ================== Method newDirectoryStream ==================
  /**
   * @param var0 original type: 'java.nio.file.Path'
   * @param var1 original type: 'java.nio.file.DirectoryStream$Filter'
   * @return original return type: 'java.nio.file.DirectoryStream'
   */
  public newDirectoryStreamSync(
    var0: java_nio_file_Path | null,
    var1: java_nio_file_DirectoryStream$Filter | null,
  ): java_nio_file_DirectoryStream | null;
  ...
  public createDirectory(
    var0: java_nio_file_Path | null,
    var1: (java_nio_file_attribute_FileAttribute | null)[] | null,
  ): Promise<void>;
  // ================== Method createDirectory ==================
  /**
   * @param var0 original type: 'java.nio.file.Path'
 ...
 * You should probably not edit this.
 */
export class FileSystemProvider extends importClass<typeof FileSystemProviderClass>(
