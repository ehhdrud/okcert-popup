...
export declare class AuthenticatorClass extends JavaClass {
  ...
  public static requestPasswordAuthentication(
    var0: java_net_InetAddress | null,
    var1: java_lang_Integer | number,
    var2: string | null,
    var3: string | null,
    var4: string | null,
  ): Promise<java_net_PasswordAuthentication | null>;
  // ================== Method requestPasswordAuthentication ==================
  /**
   * @param var0 original type: 'java.net.InetAddress'
   * @param var1 original type: 'int'
   ...
   * @return original return type: 'java.net.PasswordAuthentication'
   */
  public static requestPasswordAuthenticationSync(
    var0: java_net_InetAddress | null,
    var1: java_lang_Integer | number,
    var2: string | null,
    var3: string | null,
    var4: string | null,
  ): java_net_PasswordAuthentication | null;
  /**
  ...
  public static requestPasswordAuthentication(
    var0: string | null,
    var1: java_net_InetAddress | null,
  ...
  public static requestPasswordAuthentication(
    ...
    var4: string | null,
    var5: string | null,
    var6: java_net_URL | null,
    var7: java_net_Authenticator$RequestorType | null,
  ): Promise<java_net_PasswordAuthentication | null>;
  /**
   * @param var0 original type: 'java.lang.String'
   * @param var1 original type: 'java.net.InetAddress'
