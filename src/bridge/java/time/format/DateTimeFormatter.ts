...
export declare class DateTimeFormatterClass extends JavaClass {
  ...
  public static ofLocalizedDateTime(
    var0: java_time_format_FormatStyle | null,
    var1: java_time_format_FormatStyle | null,
  ): Promise<DateTimeFormatter | null>;
  /**
   * @param var0 original type: 'java.time.format.FormatStyle'
   * @param var1 original type: 'java.time.format.FormatStyle'
   * @return original return type: 'java.time.format.DateTimeFormatter'
   */
  public static ofLocalizedDateTimeSync(
    var0: java_time_format_FormatStyle | null,
    var1: java_time_format_FormatStyle | null,
  ...
  public withResolverFields(
    var0: (java_time_temporal_TemporalField | null)[] | null,
  ): Promise<DateTimeFormatter | null>;
  // ================== Method withResolverFields ==================
  /**
   * @param var0 original type: 'java.time.temporal.TemporalField[]'
  ...
  public parseBest(
    ...
    var1: (java_time_temporal_TemporalQuery | null)[] | null,
  ): Promise<java_time_temporal_TemporalAccessor | null>;
  // ================== Method parseBest ==================
  /**
   * @param var0 original type: 'java.lang.CharSequence'
   * @param var1 original type: 'java.time.temporal.TemporalQuery[]'
   * @return original return type: 'java.time.temporal.TemporalAccessor'
   */
  public parseBestSync(
    var0: java_lang_CharSequence | null,
    var1: (java_time_temporal_TemporalQuery | null)[] | null,
  ): java_time_temporal_TemporalAccessor | null;
  ...
  public parseUnresolved(
    var0: java_lang_CharSequence | null,
    var1: java_text_ParsePosition | null,
  ): Promise<java_time_temporal_TemporalAccessor | null>;
  // ================== Method parseUnresolved ==================
  /**
   * @param var0 original type: 'java.lang.CharSequence'
  ...
  public parse(
    var0: java_lang_CharSequence | null,
    var1: java_time_temporal_TemporalQuery | null,
 ...
 * You should probably not edit this.
 */
export class DateTimeFormatter extends importClass<typeof DateTimeFormatterClass>(
