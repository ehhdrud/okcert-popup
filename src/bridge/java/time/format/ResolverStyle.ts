...
/**
 * This class just defines types, you should import ResolverStyle instead of this.
...
export declare class ResolverStyleClass extends JavaClass {
   ...
   */
  public static readonly STRICT: ResolverStyleClass | null;
  // ================== Field SMART ==================
  /**
   * Original type: 'java.time.format.ResolverStyle'
   */
  public static readonly SMART: ResolverStyleClass | null;
  // ================== Field LENIENT ==================
  /**
   * Original type: 'java.time.format.ResolverStyle'
   */
  public static readonly LENIENT: ResolverStyleClass | null;
  // ================== Method values ==================
  /**
   * @return original return type: 'java.time.format.ResolverStyle[]'
   */
  public static values(): Promise<(ResolverStyle | null)[] | null>;
  // ================== Method values ==================
  /**
   * @return original return type: 'java.time.format.ResolverStyle[]'
   */
  public static valuesSync(): (ResolverStyle | null)[] | null;
  // ================== Method valueOf ==================
  /**
   * @param var0 original type: 'java.lang.String'
   * @return original return type: 'java.time.format.ResolverStyle'
   */
  public static valueOf(var0: string | null): Promise<ResolverStyle | null>;
  // ================== Method valueOf ==================
  /**
   * @param var0 original type: 'java.lang.String'
   * @return original return type: 'java.time.format.ResolverStyle'
   */
  public static valueOfSync(var0: string | null): ResolverStyle | null;
  /**
 ...
 * The class ResolverStyleClass only defines types, this is the class you should actually import.
 * Please note that this statement imports the underlying java class at runtime, which may take a while.
 * This was generated by java-bridge.
 * You should probably not edit this.
 */
export class ResolverStyle extends importClass<typeof ResolverStyleClass>('java.time.format.ResolverStyle') {}
