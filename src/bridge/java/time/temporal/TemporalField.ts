...
export declare class TemporalFieldClass extends JavaClass {
   ...
   */
  public rangeRefinedBy(
    var0: java_time_temporal_TemporalAccessor | null,
  ): Promise<java_time_temporal_ValueRange | null>;
  // ================== Method rangeRefinedBy ==================
  /**
   * @param var0 original type: 'java.time.temporal.TemporalAccessor'
   * @return original return type: 'java.time.temporal.ValueRange'
  ...
  public resolve(
    ...
    var1: java_time_temporal_TemporalAccessor | null,
    var2: java_time_format_ResolverStyle | null,
