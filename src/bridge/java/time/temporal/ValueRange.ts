...
export declare class ValueRangeClass extends JavaClass {
   ...
   */
  public checkValidIntValue(
    var0: java_lang_Long | bigint | number,
    var1: java_time_temporal_TemporalField | null,
  ): Promise<number>;
  // ================== Method checkValidIntValue ==================
  /**
   * @param var0 original type: 'long'
  ...
  public static of(
    ...
    var1: java_lang_Long | bigint | number,
    var2: java_lang_Long | bigint | number,
    var3: java_lang_Long | bigint | number,
  ): Promise<ValueRange | null>;
  /**
   * @param var0 original type: 'long'
   * @param var1 original type: 'long'
